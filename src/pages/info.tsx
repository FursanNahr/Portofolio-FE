        ...
        <>
            <div className="grid gap-16 max-w-[870px] mx-auto sm-desktop:gap-8 sm-desktop:max-w-[900px] sm-desktop:px-[20px]">
                ...
                <div className="flex gap-10 justify-start md:flex-col md:items-center md:w-full">
                    <div className="flex justify-center sm-desktop:w-80 md:order-2 2sm:w-full">
                    ...
                    <div className="flex flex-col gap-10 justify-center w-96 sm-desktop:gap-6 md:order-1 2sm:w-full">
                ...
                <div className="grid gap-10 md:place-items-center md:gap-8 2sm:place-items-baseline">
                    <h5 className="h-fit w-fit relative after:content-[''] after:absolute after:left-0 after:bottom-[-7px] after:w-[33%] after:h-[2px] after:bg-white md:ml-[-270px] 2sm:ml-0">Experience</h5>
                    <div className="flex justify-between md:flex-col md:gap-3 2sm:w-full">
                        <h2 className="text-2xl font-semibold">PT. Curaweda</h2>
                        <div className="w-[22rem] grid gap-1 2sm:w-full">
                ...
                <div className="grid gap-14 sm-desktop:gap-8 md:place-items-center 2sm:place-items-baseline">
                    <h5 className="relative w-fit after:content-[''] after:absolute after:left-0 after:bottom-[-7px] after:w-[40%] after:h-[2px] after:bg-white md:ml-[-315px] 2sm:ml-0">Skills</h5>
                    <div className="grid grid-cols-9 md:grid-cols-3 md:gap-y-12 md:place-items-center md:gap-x-12 2sm:w-full">
